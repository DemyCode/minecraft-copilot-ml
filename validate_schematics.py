#!/usr/bin/env python3
"""
Script to validate all schematic files in the minecraft-schematics-raw directory.
...
def main():
    ...
    print(f"Found {total_files} schematic files. Starting validation...")
    ...
    with ProcessPoolExecutor(max_workers=max_workers) as executor:
        # Submit all tasks
        future_to_file = {executor.submit(validate_schematic, file): file for file in schematic_files}
        
        # Process results as they complete
        for future in tqdm(as_completed(future_to_file), total=total_files, desc="Validating"):
